...
def getItemTransactions(config_object, itemId, affiliate=None, buyerPostalCode=None, paginationInput=None,
    ...
    response = get_response(getItemTransactions.__name__, request, encoding, config_object)
